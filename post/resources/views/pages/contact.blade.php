...
<body style="background-color: lavender;">
    ...
    <div class="container-fluid d-none d-lg-block" style="background-color:black" >
        <div class="row align-items-center py-4 px-xl-5" style="color: white;">
...
<br>
    ...
    <a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="fa fa-angle-double-up"></i> Back to Top</a>
    </div>
